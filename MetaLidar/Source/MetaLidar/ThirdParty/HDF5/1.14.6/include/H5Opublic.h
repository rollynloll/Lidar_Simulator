...
*/
#ifndef H5O_TOKEN_UNDEF_H
#define H5O_TOKEN_UNDEF_H
...
#ifdef __cplusplus
inline const H5O_token_t H5O_TOKEN_UNDEF_g = {0};  // C++17 이상에서 허용
#else
H5_DLLVAR extern const H5O_token_t H5O_TOKEN_UNDEF_g;  // 기존 방식 (C에서만 사용)
#endif
